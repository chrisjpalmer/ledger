...
func (s *LedgerAPIService) GetIncome(ctx context.Context, month int32) (ImplResponse, error) {
	// TODO - update GetIncome with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, GetIncomeResponse{}) or use other options such as http.Ok ...
	// return Response(200, GetIncomeResponse{}), nil

	// TODO: Uncomment the next line to return response Response(400, ErrorResponse{}) or use other options such as http.Ok ...
	// return Response(400, ErrorResponse{}), nil

	return Response(http.StatusNotImplemented, nil), errors.New("GetIncome method not implemented")
}
...
func (s *LedgerAPIService) GetExpenses(ctx context.Context, month int32) (ImplResponse, error) {
	// TODO - update GetExpenses with the required logic for this service method.
	// Add api_ledger_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, GetExpensesResponse{}) or use other options such as http.Ok ...
	// return Response(200, GetExpensesResponse{}), nil
